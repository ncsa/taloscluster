...
| Security group rule | 42 + ingress rules | the egress allowlist around the metadata service (see below) plus the `security` allowlists; the default project quota is 100 rules |
