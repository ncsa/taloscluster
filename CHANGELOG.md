...
- Add `talos.kubespan` (default false) enabling Talos KubeSpan, sized to the L2 MTU, advertising every node address except the external network's, and required for metal groups on another L2.
