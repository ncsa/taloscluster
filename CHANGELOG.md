...
- Join a bare-metal machine missing from the cluster during converge, never reinstalling one that already answers apid with the cluster's identity; a machine that never joins fails the run.
